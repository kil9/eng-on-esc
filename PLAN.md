...
- [x] v0.1.0 태그 발행 및 워크플로 동작 확인. https://github.com/kil9/eng-on-esc/releases/tag/v0.1.0 — `esc-eng-ime.exe` (162,304 B) + `SHA256SUMS.txt` 자동 업로드. 다운로드 후 SHA256 일치 및 VERSIONINFO 정상 노출 확인 (`ProductName=esc-eng-ime`, `FileVersion=0.1.0.0`, `CompanyName=kil9`).

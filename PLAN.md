...
### M0. 첫 릴리즈 v0.1.0 (구현 완료, 태그 발행 대기)
...
- [ ] v0.1.0 태그 발행 후 워크플로 동작 확인. Releases 페이지에서 다운로드한 exe 가 새 머신(또는 다른 사용자 계정)에서도 정상 실행되는지 종단 검증. **(사용자 작업 — 메인에 머지 후 `git tag v0.1.0 && git push origin v0.1.0`)**
